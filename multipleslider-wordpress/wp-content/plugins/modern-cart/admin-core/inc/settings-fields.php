			...
			[
				'moderncart_setting'  => [
					...
					'moderncart_cart_cart_theme_style'     => [
						...
						'description' => __( 'Pick a cart design that best suits your store\'s look and feel.', 'modern-cart' ),
					...
					'moderncart_cart_enable_coupon_field'  => [
						...
						'description' => __( 'Allow customers to enter a coupon code in the cart to apply discounts.', 'modern-cart' ),

...
//    );
    ...
    if ( gamipress_bp_is_active( 'activity' ) ) {
        $triggers[__( 'BuddyBoss Activity', 'gamipress' )] = array(
            ...
            'gamipress_bp_user_remove_favorite_activity'    => __( 'Get a like removed on an activity post', 'gamipress' ),
            'gamipress_bp_user_get_spam_activity'           => __( 'Get an activity marked as spam', 'gamipress' ),
...
function gamipress_bp_trigger_get_user_id( $user_id, $trigger, $args ) {
    ...
    switch ( $trigger ) {
        ...
        case 'gamipress_bp_user_get_spam_activity':
        case 'gamipress_bp_publish_media_activity':
        case 'gamipress_bp_publish_video_activity':
        case 'gamipress_bp_publish_document_activity':
        // BuddyPress Groups
